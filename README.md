...
- [x] v1.5 - **功能增强** (导出/依赖管理/预设)
- [ ] v2.0 - Web UI界面
- [ ] v2.5 - Ansible集成
- [ ] v3.0 - SNMP监控
- [ ] v3.5 - AI故障预测

## 🆕 v1.5 更新日志 (2026-01-30)
...
- 📦 **依赖自动安装** - 检测缺少依赖时提供一键安装功能
- 📂 **参数预设管理** - 保存和加载常用参数配置
- ⌨️ **快捷键增强** - Ctrl+E 导出, Ctrl+I 安装依赖, Ctrl+S 保存预设
- 🔒 **安全增强** - 路径验证/命令注入防护/输入过滤

**新增文件：**
- `netops_toolkit/utils/export_utils.py` - 多格式导出工具 (增强)
